...
async def test_create_post_success(client: AsyncClient, access_token: str):
    ...
    data = {"title": "post 1", "content": "some content", "published_at": "2025-02-27T04:33:14.403Z", "published": True}
...
async def test_create_post_invalid_payload_fail(client: AsyncClient, access_token: str):
    # Given
    headers = {"Authorization": f"Bearer {access_token}"}
    data = {"content": "some content", "published_at": "2025-02-27T04:33:14.403Z", "published": True}
